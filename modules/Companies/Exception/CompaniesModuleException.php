...
namespace Liminal\Module\Companies\Exception;
 ...
 * (duplicate code, unknown company) are flashed to the operator rather than
 * thrown, so they do not belong here.
 */
final class CompaniesModuleException extends LogicException implements LiminalException
{
